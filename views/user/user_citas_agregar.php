      ...
      <div class="container">
        ...
        <form class="row g-3 needs-validation" novalidate method="POST" action="<?php echo CONTROLLER_PATH; ?>citas_user.php">
          <div class="col-md-4">
            ...
            <input type="time" class="form-control" id="validationCustom02"  name="hora">
          ...
          <div class="col-md-8">
            ...
            <input type="date" class="form-control" id="validationCustom03"  name="fecha_cita">
          ...
          <div class="col-md-4">
            ...
            <select class="form-control" id="validationCustom04" name="id_centro">
              <?php
              ...
              ?>
                  <option value="<?php echo $centro["id_centro"]; ?>" ><?php echo $centro["nombre_centro"]; ?></option>
              <?php
                }
              }
              ?>
          ...
          <div class="col-md-4">
            ...
            <select class="form-control" id="validationCustom04" name="id_doctor">
              <?php
              ...
              if ($result != null) {
                ...
                while ($doctor = mysqli_fetch_assoc($result)) {
                  //Para enviar mas de un parametro se usa ?
              ?>
                  <option   value="<?php echo $doctor["id_doctor"]; ?>" ><?php echo $doctor["especializacion"]; ?></option>
              <?php
                }
              }
              ?>
          ...
          <input type="hidden" name="nueva_cita">
